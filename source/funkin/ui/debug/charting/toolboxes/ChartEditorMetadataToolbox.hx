...
class ChartEditorMetadataToolbox extends ChartEditorBaseToolbox
{
  ...
  public override function refresh():Void
  {
    ...
    var charDataOpponent:Null<CharacterData> = CharacterRegistry.instance.fetchCharacterData(chartEditorState.currentSongMetadata.playData.characters.opponent);
    if (charDataOpponent != null)
    {
      buttonCharacterOpponent.icon = haxe.ui.util.Variant.fromImageData(CharacterRegistry.instance.getCharPixelIconAsset(chartEditorState.currentSongMetadata.playData.characters.opponent));
    ...
    var charDataGirlfriend:Null<CharacterData> = CharacterRegistry.instance.fetchCharacterData(chartEditorState.currentSongMetadata.playData.characters.girlfriend);
    if (charDataGirlfriend != null)
    {
      buttonCharacterGirlfriend.icon = haxe.ui.util.Variant.fromImageData(CharacterRegistry.instance.getCharPixelIconAsset(chartEditorState.currentSongMetadata.playData.characters.girlfriend));
    ...
    {
      buttonCharacterPlayer.icon = haxe.ui.util.Variant.fromImageData(CharacterRegistry.instance.getCharPixelIconAsset(chartEditorState.currentSongMetadata.playData.characters.player));
