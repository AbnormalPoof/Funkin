...
class ChartEditorState extends UIState // UIState derives from MusicBeatState
{
  ...
  function handleHealthIcons():Void
  {
    if (healthIconsDirty)
    {
      var charDataBF = CharacterRegistry.instance.fetchCharacterData(currentSongMetadata.playData.characters.player);
      var charDataDad = CharacterRegistry.instance.fetchCharacterData(currentSongMetadata.playData.characters.opponent);
      if (healthIconBF != null)
      {
