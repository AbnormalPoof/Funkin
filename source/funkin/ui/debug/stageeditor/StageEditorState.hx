...
class StageEditorState extends UIState
{
  ...
  override public function create():Void
  {
    ...
    // group shit + assets
    var gf = CharacterRegistry.instance.fetchCharacter("gf", true);
    gf.characterType = CharacterType.GF;
    var dad = CharacterRegistry.instance.fetchCharacter("dad", true);
    dad.characterType = CharacterType.DAD;
    var bf = CharacterRegistry.instance.fetchCharacter("bf", true);
