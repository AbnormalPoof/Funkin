...
class StageEditorCharacterToolbox extends StageEditorDefaultToolbox
{
  ...
  override public function refresh()
  {
    ...
    var charData = CharacterRegistry.instance.fetchCharacterData(stageEditorState.selectedChar.characterId);
    characterTypeButton.icon = (charData == null ? null : CharacterRegistry.instance.getCharPixelIconAsset(stageEditorState.selectedChar.characterId));
...
class StageEditorCharacterMenu extends Menu // copied from chart editor
{
  override public function new(state:StageEditorState, parent:StageEditorCharacterToolbox)
  {
    ...
    for (charIndex => charId in charIds)
    {
      ...
      var LIMIT = 6;
      charButton.icon = CharacterRegistry.instance.getCharPixelIconAsset(charId);
      ...
      charButton.onClick = _ -> {
        ...
        var newChar = CharacterRegistry.instance.fetchCharacter(charId, true);
